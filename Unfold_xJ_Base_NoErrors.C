...
void Unfold_xJ_Base_NoErrors(string infile1 = "Xj_2D_Response_Base_Bins19_All-Herwig-Jet10-R04-Run21.root", string infile2 = "Xj_2D_Response_Base_Bins19_All-Herwig-Jet30-R04-Run21.root",const std::string configfile = "binning_original.config", int niterations = 6){
...
// Draw the 2D histogram
 ...
 h_pt_lead_truth_matched->GetZaxis()->SetLabelSize(0.035);
  ...
  h_unfolded_pt1pt2_full = (TH2D*)unfolded_pt1pt2_full->Hreco(RooUnfold::ErrorTreatment::kCovariance);
  h_unfolded_pt1pt2_half = (TH2D*)unfolded_pt1pt2_half->Hreco(RooUnfold::ErrorTreatment::kCovariance);

  RooUnfoldBayes *unfolded_pt1pt2_data = new RooUnfoldBayes(response_pt1pt2_full,h_pt1pt2_data,niterations);
  h_unfolded_pt1pt2_data = (TH2D*)unfolded_pt1pt2_data->Hreco(RooUnfold::ErrorTreatment::kCovariance);
