...
void Combine_Skim_Unfold_Write_xJ_Play(string infile1 = "Xj_2D_Response_Bins19_R4_Play_Smear_Flatten_pythia8-Jet10-Run21-multiR.root", string infile2 = "Xj_2D_Response_Bins19_R4_Play_Smear_Flatten_pythia8-Jet30-Run21-multiR.root", string infile3 ="Xj_2D_Response_Bins19_R4_Play_Smear_Flatten_pythia8-Jet20-Run21-multiR.root", string infile_data = "Xj_2D_Response_Bins19_R4_Data_Flatten_output_run2pp_ana468_2024p012_v001_data_All.Root", const std::string configfile = "binning_original.config", int niterations = 6, bool Pythia = true){
  ...
  TH1D* h_xj_classical_truth_30_40 = (TH1D*)infile01->Get("h_xj_classical_truth_30_40");
  TH1D* h_xj_classical_reco_30_40  = (TH1D*)infile01->Get("h_xj_classical_reco_30_40");

  TH1D* h_xj_classical_truth_40_60 = (TH1D*)infile01->Get("h_xj_classical_truth_40_60");
  TH1D* h_xj_classical_reco_40_60  = (TH1D*)infile01->Get("h_xj_classical_reco_40_60");

  //linear and AJ plots

  TH1D* h_linear_truth_xj = (TH1D*)infile01->Get("h_linear_truth_xj");
  TH1D* h_linear_reco_xj = (TH1D*)infile01->Get("h_linear_reco_xj");

  TH1D* h_linear_truth_xj_30_40 = (TH1D*)infile01->Get("h_linear_truth_xj_30_40");
  TH1D* h_linear_reco_xj_30_40  = (TH1D*)infile01->Get("h_linear_reco_xj_30_40");

  TH1D* h_linear_truth_xj_40_60 = (TH1D*)infile01->Get("h_linear_truth_xj_40_60");
  TH1D* h_linear_reco_xj_40_60  = (TH1D*)infile01->Get("h_linear_reco_xj_40_60");

  TH1D* h_linear_truth_Aj = (TH1D*)infile01->Get("h_linear_truth_Aj");
  TH1D* h_linear_reco_Aj = (TH1D*)infile01->Get("h_linear_reco_Aj");

  TH1D* h_linear_truth_Aj_30_40 = (TH1D*)infile01->Get("h_linear_truth_Aj_30_40");
  TH1D* h_linear_reco_Aj_30_40  = (TH1D*)infile01->Get("h_linear_reco_Aj_30_40");

  TH1D* h_linear_truth_Aj_40_60 = (TH1D*)infile01->Get("h_linear_truth_Aj_40_60");
  TH1D* h_linear_reco_Aj_40_60  = (TH1D*)infile01->Get("h_linear_reco_Aj_40_60");
  ...
  h_pt_lead_reco_matched  ->Add((TH1D*)infile02->Get("h_pt_lead_reco_matched"));
   ...
   // Add infile02 histograms
  h_xj_classical_truth     ->Add((TH1D*)infile02->Get("h_xj_classical_truth"));
  h_xj_classical_reco      ->Add((TH1D*)infile02->Get("h_xj_classical_reco"));
  h_xj_classical_truth_30_40->Add((TH1D*)infile02->Get("h_xj_classical_truth_30_40"));
  h_xj_classical_reco_30_40 ->Add((TH1D*)infile02->Get("h_xj_classical_reco_30_40"));
  h_xj_classical_truth_40_60->Add((TH1D*)infile02->Get("h_xj_classical_truth_40_60"));
  h_xj_classical_reco_40_60 ->Add((TH1D*)infile02->Get("h_xj_classical_reco_40_60"));
  
  h_linear_truth_xj        ->Add((TH1D*)infile02->Get("h_linear_truth_xj"));
  h_linear_reco_xj         ->Add((TH1D*)infile02->Get("h_linear_reco_xj"));
  h_linear_truth_xj_30_40  ->Add((TH1D*)infile02->Get("h_linear_truth_xj_30_40"));
  h_linear_reco_xj_30_40   ->Add((TH1D*)infile02->Get("h_linear_reco_xj_30_40"));
  h_linear_truth_xj_40_60  ->Add((TH1D*)infile02->Get("h_linear_truth_xj_40_60"));
  h_linear_reco_xj_40_60   ->Add((TH1D*)infile02->Get("h_linear_reco_xj_40_60"));

  h_linear_truth_Aj        ->Add((TH1D*)infile02->Get("h_linear_truth_Aj"));
  h_linear_reco_Aj         ->Add((TH1D*)infile02->Get("h_linear_reco_Aj"));
  h_linear_truth_Aj_30_40  ->Add((TH1D*)infile02->Get("h_linear_truth_Aj_30_40"));
  h_linear_reco_Aj_30_40   ->Add((TH1D*)infile02->Get("h_linear_reco_Aj_30_40"));
  h_linear_truth_Aj_40_60  ->Add((TH1D*)infile02->Get("h_linear_truth_Aj_40_60"));
  h_linear_reco_Aj_40_60   ->Add((TH1D*)infile02->Get("h_linear_reco_Aj_40_60"));
  ...
  h_pt_lead_reco_matched  ->Add((TH1D*)infile03->Get("h_pt_lead_reco_matched"));
   h_xj_classical_truth ->Add((TH1D*)infile03->Get("h_xj_classical_truth"));
   h_xj_classical_reco ->Add((TH1D*)infile03->Get("h_xj_classical_reco"));

   // Add infile03 histograms
   h_xj_classical_truth     ->Add((TH1D*)infile03->Get("h_xj_classical_truth"));
   h_xj_classical_reco      ->Add((TH1D*)infile03->Get("h_xj_classical_reco"));
   h_xj_classical_truth_30_40->Add((TH1D*)infile03->Get("h_xj_classical_truth_30_40"));
   h_xj_classical_reco_30_40 ->Add((TH1D*)infile03->Get("h_xj_classical_reco_30_40"));
   h_xj_classical_truth_40_60->Add((TH1D*)infile03->Get("h_xj_classical_truth_40_60"));
   h_xj_classical_reco_40_60 ->Add((TH1D*)infile03->Get("h_xj_classical_reco_40_60"));

   h_linear_truth_xj        ->Add((TH1D*)infile03->Get("h_linear_truth_xj"));
   h_linear_reco_xj         ->Add((TH1D*)infile03->Get("h_linear_reco_xj"));
   h_linear_truth_xj_30_40  ->Add((TH1D*)infile03->Get("h_linear_truth_xj_30_40"));
   h_linear_reco_xj_30_40   ->Add((TH1D*)infile03->Get("h_linear_reco_xj_30_40"));
   h_linear_truth_xj_40_60  ->Add((TH1D*)infile03->Get("h_linear_truth_xj_40_60"));
   h_linear_reco_xj_40_60   ->Add((TH1D*)infile03->Get("h_linear_reco_xj_40_60"));

   h_linear_truth_Aj        ->Add((TH1D*)infile03->Get("h_linear_truth_Aj"));
   h_linear_reco_Aj         ->Add((TH1D*)infile03->Get("h_linear_reco_Aj"));
   h_linear_truth_Aj_30_40  ->Add((TH1D*)infile03->Get("h_linear_truth_Aj_30_40"));
   h_linear_reco_Aj_30_40   ->Add((TH1D*)infile03->Get("h_linear_reco_Aj_30_40"));
   h_linear_truth_Aj_40_60  ->Add((TH1D*)infile03->Get("h_linear_truth_Aj_40_60"));
   h_linear_reco_Aj_40_60   ->Add((TH1D*)infile03->Get("h_linear_reco_Aj_40_60"));
...
TH1D* h_xj_unfold_data  = new TH1D("h_xj_unfold_data_20_60", ";x_{J};", nbins, ixj_bins);
 ...
 TH1D* h_xj_reco_projection   = new TH1D("h_xj_reco_projection", ";x_{J};", nbins, ixj_bins);
 TH1D* h_xj_truth_projection   = new TH1D("h_xj_truth_projection", ";x_{J};", nbins, ixj_bins);
 // Projections with 30–40 GeV suffix
TH1D* h_xj_reco_projection_30_40  = new TH1D("h_xj_reco_projection_30_40",  ";x_{J};", nbins, ixj_bins);
TH1D* h_xj_truth_projection_30_40 = new TH1D("h_xj_truth_projection_30_40", ";x_{J};", nbins, ixj_bins);

// Projections with 40–60 GeV suffix
TH1D* h_xj_reco_projection_40_60  = new TH1D("h_xj_reco_projection_40_60",  ";x_{J};", nbins, ixj_bins);
TH1D* h_xj_truth_projection_40_60 = new TH1D("h_xj_truth_projection_40_60", ";x_{J};", nbins, ixj_bins);
...
// Projection calls
  ...
  xj_functions::project_xj(h_pt1pt2_reco_full,   h_xj_reco_projection,   nbins, measure_leading_bin , nbins - 1, measure_subleading_bin, nbins - 1);
  xj_functions::project_xj(h_pt1pt2_truth_full,   h_xj_truth_projection,   nbins, truth_leading_bin , nbins - 1, truth_subleading_bin, nbins - 1);

  // With 30–40 suffix
  xj_functions::project_xj(h_pt1pt2_reco_full,   h_xj_reco_projection_30_40,   nbins, measure_leading_bin + 3,   nbins - 4, measure_subleading_bin,   nbins - 1);
  xj_functions::project_xj(h_pt1pt2_truth_full,  h_xj_truth_projection_30_40,  nbins, measure_leading_bin + 3,     nbins - 4, measure_subleading_bin,     nbins - 1);

  // With 40–60 suffix
  xj_functions::project_xj(h_pt1pt2_reco_full,   h_xj_reco_projection_40_60,   nbins, measure_leading_bin + 5,   nbins - 1, measure_subleading_bin,   nbins - 1);
  xj_functions::project_xj(h_pt1pt2_truth_full,  h_xj_truth_projection_40_60,  nbins, measure_leading_bin + 5,     nbins - 1, measure_subleading_bin,     nbins - 1);
  ...
  xj_functions::normalize_histo(h_xj_truth_projection, nbins);
  xj_functions::normalize_histo(h_xj_reco_projection, nbins);

  // Classical histos
xj_functions::normalize_histo(h_xj_classical_truth_30_40, nbins);
xj_functions::normalize_histo(h_xj_classical_reco_30_40,  nbins);

xj_functions::normalize_histo(h_xj_classical_truth_40_60, nbins);
xj_functions::normalize_histo(h_xj_classical_reco_40_60,  nbins);

// Projections
xj_functions::normalize_histo(h_xj_truth_projection_30_40, nbins);
xj_functions::normalize_histo(h_xj_reco_projection_30_40,  nbins);

xj_functions::normalize_histo(h_xj_truth_projection_40_60, nbins);
xj_functions::normalize_histo(h_xj_reco_projection_40_60,  nbins);
 ...
 xj_functions::plotxj_and_ratio(can_xj_projected,h_xj_classical_reco, h_xj_classical_truth,h_xj_truth_projection, h_xj_reco_projection,true, "x_{J}","Classical/Truth",0, 1.0, 4, 53, 2, 20,  kGreen+1,  20,  8, 53);
 TLegend *xj_projected = new TLegend(0.6, 0.7, 0.85, 0.85);
xj_projected->AddEntry(h_xj_classical_reco,   "Classical Reco",    "p");
xj_projected->AddEntry(h_xj_classical_truth,  "Classical Truth",   "p");
xj_projected->AddEntry(h_xj_truth_projection,  "Projected Truth",   "p");
xj_projected->AddEntry(h_xj_reco_projection,   "Projected Reco",    "p");
xj_projected->Draw();

 // ===================== 30–40 GeV =====================
TCanvas* can_xj_projected_30_40 =
    new TCanvas("can_xj_projected_30_40", "x_{J} (30 < p_{T,1} < 40 GeV)", 700, 800);

xj_functions::plotxj_and_ratio(
    can_xj_projected_30_40,
    h_xj_classical_reco_30_40,    // unfolded/reco
    h_xj_classical_truth_30_40,   // truth ref for classical
    h_xj_truth_projection_30_40,  // projected truth
    h_xj_reco_projection_30_40,   // projected reco
    true, "x_{J}", "Classical/Truth",
    0, 1.0,
    4, 53,        // colors/markers for first pair
    2, 20,        // colors/markers for second pair
    kGreen+1, 20, // (kept from your call)
    8, 53
);

// Legend (30–40)
TLegend* leg_xj_projected_30_40 = new TLegend(0.60, 0.70, 0.85, 0.85);
leg_xj_projected_30_40->SetBorderSize(0);
leg_xj_projected_30_40->SetFillStyle(0);
leg_xj_projected_30_40->SetTextSize(0.03);
leg_xj_projected_30_40->SetHeader("30 < p_{T,1} < 40 GeV","C");
leg_xj_projected_30_40->AddEntry(h_xj_classical_reco_30_40,   "Classical Reco",   "p");
leg_xj_projected_30_40->AddEntry(h_xj_classical_truth_30_40,  "Classical Truth",  "p");
leg_xj_projected_30_40->AddEntry(h_xj_truth_projection_30_40, "Projected Truth",  "p");
leg_xj_projected_30_40->AddEntry(h_xj_reco_projection_30_40,  "Projected Reco",   "p");
leg_xj_projected_30_40->Draw();


// ===================== 40–60 GeV =====================
TCanvas* can_xj_projected_40_60 =
    new TCanvas("can_xj_projected_40_60", "x_{J} (40 < p_{T,1} < 60 GeV)", 700, 800);

xj_functions::plotxj_and_ratio(
    can_xj_projected_40_60,
    h_xj_classical_reco_40_60,
    h_xj_classical_truth_40_60,
    h_xj_truth_projection_40_60,
    h_xj_reco_projection_40_60,
    true, "x_{J}", "Classical/Truth",
    0, 1.0,
    4, 53,
    2, 20,
...
// Legend (40–60)
TLegend* leg_xj_projected_40_60 = new TLegend(0.60, 0.70, 0.85, 0.85);
leg_xj_projected_40_60->SetBorderSize(0);
leg_xj_projected_40_60->SetFillStyle(0);
leg_xj_projected_40_60->SetTextSize(0.03);
leg_xj_projected_40_60->SetHeader("40 < p_{T,1} < 60 GeV","C");
leg_xj_projected_40_60->AddEntry(h_xj_classical_reco_40_60,   "Classical Reco",   "p");
leg_xj_projected_40_60->AddEntry(h_xj_classical_truth_40_60,  "Classical Truth",  "p");
leg_xj_projected_40_60->AddEntry(h_xj_truth_projection_40_60, "Projected Truth",  "p");
leg_xj_projected_40_60->AddEntry(h_xj_reco_projection_40_60,  "Projected Reco",   "p");
leg_xj_projected_40_60->Draw();
...
TLegend* xj_data_21;
 ...
 //Name and Write histograms
	  ...
	  TString outpath = "UnfoldedxJHists_Play_" ;
	  if (Pythia){
	 ...
	 if (infile1.find("_R2_") != std::string::npos){
	  ...
	  // Linear Aj
	  h_linear_truth_Aj         ->Write();
	  h_linear_reco_Aj          ->Write();
	  ...
	  h_xj_truth_projection->Write();
	  h_xj_reco_projection->Write();

	  // 30–40 GeV

	  h_xj_truth_projection_30_40->Write();
	  h_xj_reco_projection_30_40->Write();

	  // 40–60 GeV

	  h_xj_truth_projection_40_60->Write();
	  h_xj_reco_projection_40_60->Write();
