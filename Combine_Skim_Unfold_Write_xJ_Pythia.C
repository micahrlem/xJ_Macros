...
TH1D* h_xj_unfold_data  = new TH1D("h_xj_unfold_data_20_60", ";x_{J};", nbins, ixj_bins);
 ...
 cout << "base leading bin range: " <<  ipt_bins[measure_leading_bin + 0] << " - " <<  ipt_bins[nbins - 1] << endl;
  ...
  //project xj
  xj_functions::project_xj(h_pt1pt2_reco_full, h_xj_reco_full, nbins, measure_leading_bin + 0, nbins - 2, measure_subleading_bin, nbins - 2);
  xj_functions::project_xj(h_pt1pt2_truth_full, h_xj_truth_full, nbins, measure_leading_bin  + 0, nbins - 2, measure_subleading_bin, nbins - 2);
  xj_functions::project_xj(h_pt1pt2_unfold_full, h_xj_unfold_full, nbins, measure_leading_bin  + 0, nbins - 2, measure_subleading_bin, nbins - 2);
   xj_functions::project_xj(h_pt1pt2_reco_half, h_xj_reco_half, nbins, measure_leading_bin  + 0, nbins - 2, measure_subleading_bin, nbins - 2);
   xj_functions::project_xj(h_pt1pt2_truth_half, h_xj_truth_half, nbins, measure_leading_bin  + 0, nbins - 2, measure_subleading_bin, nbins - 2);
  xj_functions::project_xj(h_pt1pt2_unfold_half, h_xj_unfold_half, nbins, measure_leading_bin  + 0, nbins - 2, measure_subleading_bin, nbins - 2);

  xj_functions::project_xj(h_pt1pt2_unfold_data, h_xj_unfold_data, nbins, measure_leading_bin + 0, nbins - 2, measure_subleading_bin, nbins - 2);
  xj_functions::project_xj(h_pt1pt2_data, h_xj_data, nbins, measure_leading_bin + 0, nbins - 2, measure_subleading_bin, nbins - 2);
...
// Projection calls
  xj_functions::project_xj(h_pt1pt2_reco_full,   h_xj_reco_full_20_30,   nbins, measure_leading_bin + 0, nbins - 7, measure_subleading_bin, nbins - 7);
  xj_functions::project_xj(h_pt1pt2_truth_full,  h_xj_truth_full_20_30,  nbins, measure_leading_bin + 0, nbins - 7, measure_subleading_bin, nbins - 7);
  xj_functions::project_xj(h_pt1pt2_unfold_full, h_xj_unfold_full_20_30, nbins, measure_leading_bin + 0, nbins - 7, measure_subleading_bin, nbins - 7);
  xj_functions::project_xj(h_pt1pt2_reco_half,   h_xj_reco_half_20_30,   nbins, measure_leading_bin + 0, nbins - 7, measure_subleading_bin, nbins - 7);
  xj_functions::project_xj(h_pt1pt2_truth_half,  h_xj_truth_half_20_30,  nbins, measure_leading_bin + 0, nbins - 7, measure_subleading_bin, nbins - 7);
  xj_functions::project_xj(h_pt1pt2_unfold_half, h_xj_unfold_half_20_30, nbins, measure_leading_bin + 0, nbins - 7, measure_subleading_bin, nbins - 7);
  xj_functions::project_xj(h_pt1pt2_unfold_data, h_xj_unfold_data_20_30, nbins, measure_leading_bin + 0, nbins - 7, measure_subleading_bin, nbins - 7);
  xj_functions::project_xj(h_pt1pt2_data,        h_xj_data_20_30,        nbins, measure_leading_bin + 0, nbins - 7, measure_subleading_bin, nbins - 7);
  ...
  // Projection calls
  xj_functions::project_xj(h_pt1pt2_reco_full,   h_xj_reco_full_30_40,   nbins, measure_leading_bin + 3, nbins - 5, measure_subleading_bin, nbins - 5);
  xj_functions::project_xj(h_pt1pt2_truth_full,  h_xj_truth_full_30_40,  nbins, measure_leading_bin + 3, nbins - 5, measure_subleading_bin, nbins - 5);
  xj_functions::project_xj(h_pt1pt2_unfold_full, h_xj_unfold_full_30_40, nbins, measure_leading_bin + 3, nbins - 5, measure_subleading_bin, nbins - 5);
  xj_functions::project_xj(h_pt1pt2_reco_half,   h_xj_reco_half_30_40,   nbins, measure_leading_bin + 3, nbins - 5, measure_subleading_bin, nbins - 5);
  xj_functions::project_xj(h_pt1pt2_truth_half,  h_xj_truth_half_30_40,  nbins, measure_leading_bin + 3, nbins - 5, measure_subleading_bin, nbins - 5);
  xj_functions::project_xj(h_pt1pt2_unfold_half, h_xj_unfold_half_30_40, nbins, measure_leading_bin + 3, nbins - 5, measure_subleading_bin, nbins - 5);
  xj_functions::project_xj(h_pt1pt2_unfold_data, h_xj_unfold_data_30_40, nbins, measure_leading_bin + 3, nbins - 5, measure_subleading_bin, nbins - 5);
  xj_functions::project_xj(h_pt1pt2_data,        h_xj_data_30_40,        nbins, measure_leading_bin + 3, nbins - 5, measure_subleading_bin, nbins - 5);
  ...
  // Projection calls
  xj_functions::project_xj(h_pt1pt2_reco_full,   h_xj_reco_full_40_60,   nbins, measure_leading_bin + 5, nbins - 2, measure_subleading_bin, nbins - 2);
  xj_functions::project_xj(h_pt1pt2_truth_full,  h_xj_truth_full_40_60,  nbins, measure_leading_bin + 5, nbins - 2, measure_subleading_bin, nbins - 2);
  xj_functions::project_xj(h_pt1pt2_unfold_full, h_xj_unfold_full_40_60, nbins, measure_leading_bin + 5, nbins - 2, measure_subleading_bin, nbins - 2);
  xj_functions::project_xj(h_pt1pt2_reco_half,   h_xj_reco_half_40_60,   nbins, measure_leading_bin + 5, nbins - 2, measure_subleading_bin, nbins - 2);
  xj_functions::project_xj(h_pt1pt2_truth_half,  h_xj_truth_half_40_60,  nbins, measure_leading_bin + 5, nbins - 2, measure_subleading_bin, nbins - 2);
  xj_functions::project_xj(h_pt1pt2_unfold_half, h_xj_unfold_half_40_60, nbins, measure_leading_bin + 5, nbins - 2, measure_subleading_bin, nbins - 2);
  xj_functions::project_xj(h_pt1pt2_unfold_data, h_xj_unfold_data_40_60, nbins, measure_leading_bin + 5, nbins - 2, measure_subleading_bin, nbins - 2);
  xj_functions::project_xj(h_pt1pt2_data,        h_xj_data_40_60,        nbins, measure_leading_bin + 5, nbins - 2, measure_subleading_bin, nbins - 2);
...
TLegend* xj_data_21;
 ...
 //Name and Write histograms
	  ...
	  TString outpath = "UnfoldedxJHists_calofit_" ;
	  if (Pythia){
