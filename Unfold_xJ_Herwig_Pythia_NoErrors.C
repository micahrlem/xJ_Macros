...
void Unfold_xJ_Herwig_Pythia_NoErrors(
    string infilepythia1 = "Xj_2D_Response_Base_Bins19_pythia8-Jet10-Run21-multiR.root",
    string infilepythia2 = "Xj_2D_Response_Base_Bins19_pythia8-Jet30-Run21-multiR.root",
    string infileherwig1 = "Xj_2D_Response_Base_Bins19_Herwig-Jet10-Run21-multiR.root",
    string infileherwig2 = "Xj_2D_Response_Base_Bins19_Herwig-Jet30-Run21-multiR.root",
...
h_unfolded_pt1pt2_full_pythia = (TH2D*)unfolded_pt1pt2_full_pythia->Hreco(RooUnfold::ErrorTreatment::kCovariance);
h_unfolded_pt1pt2_half_pythia = (TH2D*)unfolded_pt1pt2_half_pythia->Hreco(RooUnfold::ErrorTreatment::kCovariance);

RooUnfoldBayes* unfolded_pt1pt2_data_pythia = new RooUnfoldBayes(response_pt1pt2_full_pythia, h_pt1pt2_data, niterations);
h_unfolded_pt1pt2_data_pythia = (TH2D*)unfolded_pt1pt2_data_pythia->Hreco(RooUnfold::ErrorTreatment::kCovariance);
...
h_unfolded_pt1pt2_full_herwig = (TH2D*)unfolded_pt1pt2_full_herwig->Hreco(RooUnfold::ErrorTreatment::kCovariance);
h_unfolded_pt1pt2_half_herwig = (TH2D*)unfolded_pt1pt2_half_herwig->Hreco(RooUnfold::ErrorTreatment::kCovariance);

RooUnfoldBayes* unfolded_pt1pt2_data_herwig = new RooUnfoldBayes(response_pt1pt2_full_herwig, h_pt1pt2_data, niterations);
h_unfolded_pt1pt2_data_herwig = (TH2D*)unfolded_pt1pt2_data_herwig->Hreco(RooUnfold::ErrorTreatment::kCovariance);
