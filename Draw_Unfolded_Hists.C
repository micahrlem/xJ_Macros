...
std::vector<std::string> filenames = {
    "UnfoldedxJHists_pythia8_R2.root",
    "UnfoldedxJHists_pythia8_R4.root",
    "UnfoldedxJHists_pythia8_negJER_R2.root",
    "UnfoldedxJHists_pythia8_negJER_R4.root",
    "UnfoldedxJHists_pythia8_posJER_R2.root",
    "UnfoldedxJHists_pythia8_posJER_R4.root",
    "UnfoldedxJHists_pythia8_negJES_R2.root",
    "UnfoldedxJHists_pythia8_negJES_R4.root",
    "UnfoldedxJHists_pythia8_posJES_R2.root",
    "UnfoldedxJHists_pythia8_posJES_R4.root",
    "UnfoldedxJHists_Herwig_R2.root",
    "UnfoldedxJHists_Herwig_R4.root",
    "UnfoldedxJHists_Herwig_negJER_R2.root",
    "UnfoldedxJHists_Herwig_negJER_R4.root",
    "UnfoldedxJHists_Herwig_posJER_R2.root",
    "UnfoldedxJHists_Herwig_posJER_R4.root",
    "UnfoldedxJHists_Herwig_negJES_R2.root",
    "UnfoldedxJHists_Herwig_negJES_R4.root",
    "UnfoldedxJHists_Herwig_posJES_R2.root",
    "UnfoldedxJHists_Herwig_posJES_R4.root"
};
...
std::vector<std::string> gens = {"pythia8", "Herwig"};
...
for (const auto& pt_range : pt_ranges_compare) {
    ...
    std::string tag_r4_pythia = pt_range + "_pythia8_R4";
    std::string tag_r4_herwig = pt_range + "_Herwig_R4";
    std::string tag_r2_pythia = pt_range + "_pythia8_R2";
    std::string tag_r2_herwig = pt_range + "_Herwig_R2";
    ...
    std::string outpath = "xj_plot_pdfs/" + canvas_key + ".pdf";
    ...
    for (const auto& pt_range : pt_ranges_closure) {
        for (const auto& gen : gens) {
            for (const auto& R : Rvals) {
                ...
                std::string simtype     = (gen == "pythia8") ? "PYTHIA 8" : "HERWIG 7";
        ...
        for (const auto& R : Rvals) {
            ...
            xj_functions::draw_xj_legend(leg_main, legend_key.c_str(), 0.61, 0.75, 0.71, 0.90,
                ...
                named_histograms[h_jer_neg],
					 simtype.c_str(), "Unfold", "Unfold + JER", "Unfold - JER",true);
            ...
            std::string outpath_jer = "xj_plot_pdfs/" + canvas_jer_key + ".pdf";
    ...
    for (const auto& gen : gens) {
        for (const auto& R : Rvals) {
            ...
            xj_functions::draw_xj_legend(leg_main, legend_key.c_str(), 0.61, 0.75, 0.71, 0.90,
                ...
                simtype.c_str(), "Unfold", "Unfold + JES", "Unfold - JES", true);
            ...
            std::string outpath_jes = "xj_plot_pdfs/" + canvas_jes_key + ".pdf";
