...
// Function to normalize histograms properly
void normalize_histo(TH1D* h, const int nbins) {
    Double_t bin_contents[19] = {0}; // Now explicitly using 19 bins
    Double_t bin_errors[19] = {0};
    Double_t integral = 0;
...
void Draw_QA_xJTest(string infile01 = "Hists_xJ_ProjectionTest_TREE_DIJET_v6_1_ana462_2024p010_v001_gl10-00047352-00047733.root" )
...
normalize_histo(h_xj_classical, 19);
normalize_histo(h_xj_projected, 19);
